...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tp3

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tp3: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tp3 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${TESTDIR}/tests/BibliographieTesteur.o: tests/BibliographieTesteur.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BibliographieTesteur.o tests/BibliographieTesteur.cpp


${TESTDIR}/tests/JournalTesteur.o: tests/JournalTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/JournalTesteur.o tests/JournalTesteur.cpp


${TESTDIR}/tests/OuvrageTesteur.o: tests/OuvrageTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/OuvrageTesteur.o tests/OuvrageTesteur.cpp


${TESTDIR}/tests/ReferenceTesteur.o: tests/ReferenceTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ReferenceTesteur.o tests/ReferenceTesteur.cpp
